#include "GlobalData_tests.h"
  ...
  void GlobalData_tests::lattice_input_data_handling (const std::string path_output,
  ...
  // *****************************************************************************
  // simplifies and cleans read_parameters function
  void GlobalData_tests::eigenvec_perambulator_input_data_handling (
  ...
  // *****************************************************************************
  // simplifies and cleans read_parameters function
  void GlobalData_tests::config_input_data_handling (const int start_config,
  ...
  // *****************************************************************************
  // simplifies and cleans read_parameters function
  void GlobalData_tests::quark_check (quark quarks) {
